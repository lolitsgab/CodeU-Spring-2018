           ...
           <span class="iconBackground"></span>
            <div class="col-xs-12 col-md-6 align-right">
                <div class="timeline-text-content">
                    <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">Celestine Co</h4>
                    <p class="mbr-timeline-text mbr-fonts-style display-7">Celestine Co at 9:23 PM<br>Yeah talk to you tomorrow!</p>
                 </div>
            </div>
            </div>
            ...
            <div class="row timeline-element  separline">
                ...
                <div class="col-xs-12 col-md-6 align-left ">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">Alison Tsoi</h4>
                ...
                <div class="col-xs-12 col-md-6 align-right">
                    <div class="timeline-text-content">
                        <h4 class="mbr-timeline-title pb-3 mbr-fonts-style display-5">
                            Monte Misa</h4>      
                        <p class="mbr-timeline-text mbr-fonts-style display-7">Gabriel at 5:32 PM<br>Everything is going well, thanks!</p>
                    </div>
                </div>
            </div>
